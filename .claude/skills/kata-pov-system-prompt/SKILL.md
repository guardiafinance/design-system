...
description: "Style. Engineering — Agents (pre-operational stage): write a PoV's minimum viable system prompt with an explicit stage: pre-operational declaration"
---
