---
name: kata-ideation-from-insight
description: "(other fields unchanged). Product Discovery — promotion of an insight with status: approved into an Idea under docs/discovery/{topic}/ideas/"
---
