...
description: "Scope — reconciliation / rec-pov-classifier. Engineering — Agents (pre-operational stage): delimits the scope of an agent PoV before any instrumentation or implementation"
---
