---
name: kata-pr-review
description: "Verify (in another shell):. Start a Claude Code session to review a Pull Request, ensuring the turns are counted in the Review subsection of the cost stamp (kata-pr-cost-stamp)"
---
