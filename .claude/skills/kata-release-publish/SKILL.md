---
name: kata-release-publish
description: "Only edit the notes if the prepared changelog is substantially more informative.. Phase 2 of the release cycle orchestrated by warrior-janus — annotated/signed tag creation, push to the remote, wait/edit the release via GitHub Action, and post-condition verification"
---
