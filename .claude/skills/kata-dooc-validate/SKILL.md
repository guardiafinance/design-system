---
name: kata-dooc-validate
description: "DoOC — rec-classifier. Engineering — Agents: gate-keeping the promotion from pre-operational to operational-concrete per lex-agent-construction-directives"
---
