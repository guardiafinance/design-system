...
description: "intermediate layers may have leftovers:. Merge a chain of stacked Pull Requests in the correct order (base → top), explicitly updating the next layer's base after each merge, using gh + git (vanilla path)"
---
