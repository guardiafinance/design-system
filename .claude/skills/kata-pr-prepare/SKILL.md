...
description: "2. Issue — sync (intra-artifact mutex). Phase 7 of the Issue-Driven flow — creating a branch, pushing files, and opening a PR on GitHub via MCP, with a structured body referencing all flow artifacts"
---
