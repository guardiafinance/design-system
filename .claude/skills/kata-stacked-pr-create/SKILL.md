...
description: "the URLs, but the loop below needs the numeric IDs):. Decompose a large feature into a chain of PRs reviewable in isolation, using git + gh (vanilla path)"
---
