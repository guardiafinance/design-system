---
name: warrior-argos
description: "🔍 Argos Review of PR — #142 (commit a1b2c3d4). Engineering — Quality: post-PR review on demand by the human reviewer, orchestrating all review katas, alignment with Issue/PRD/Capability Spec, local test execution, and breaking-change detection on public contracts"
---
