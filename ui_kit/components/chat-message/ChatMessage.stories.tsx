...
export const DarkTheme: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Papéis (user · assistant · system) e estados (streaming · error) sobre fundo escuro. As bolhas trocam de paleta automaticamente via tokens (primary/muted/accent/destructive).",
      },
    },
  },
  render: () => (
